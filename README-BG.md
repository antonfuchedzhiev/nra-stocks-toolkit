...
>**Уверете се, че винаги използвате най-новата версия, която в момента е v. 1.0.3.**
...
### Прегледайте и попълване на продажби от борси извън ЕС
  1. Изберете таблицата "Продадени акции". Можете да филтрирате по година, за да съответства на данъчния период.
  2. Уерете се, че е избран филтърът "ДЪРЖАВИ ИЗВЪН ЕС" (тъй като Приложение 5, Част I, Таблица II се отнася само за продажби на борси извън ЕС), след което прегледайте детайлите.
...
### Прегледайте и попълване на продажби от борси в ЕС
  Ще го добавя скоро, само да наваксам малко сън 🫩
