...
**For the Bulgarian version of this document, click [here](README.md). (За версия на този документ на български език, кликни [тук](README.md)).**
...
## Как да използвате
**⚠️ ВАЖНО: Тази версия е в бета фаза, което означава, че е пусната за тестване, отстраняване на грешки и подобрения.**
